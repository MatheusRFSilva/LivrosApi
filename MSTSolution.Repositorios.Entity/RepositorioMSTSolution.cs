...
namespace MSTSolution.Repositorios.Entity
{
    public abstract class RepositorioMSTSolution<TDominio, TChave> : IRepositorioMSTSolution<TDominio, TChave>
        where TDominio : class
    {
        protected DbContext _context;

        public RepositorioMSTSolution(DbContext context)
        {
            _context = context;
        }
        public void Atualziar(TDominio dominio)
        {
